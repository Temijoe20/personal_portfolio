import { Instagram, Linkedin, Twitter, Twitch, Mail, MapPin, Phone, Send } from "lucide-react";
                        ...
                        <div className="space-y-6 justify-center">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+2349061759083" className="text-muted-foreground hover:text-primary transition-colors">
                                        +2349061759083
                                    </a>
                                </div>
                            </div>
